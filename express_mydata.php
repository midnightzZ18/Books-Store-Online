...
// Fetch the id associated with the logged-in user
$user_name = $_SESSION['user_name'];
$user_id_query = "SELECT id FROM delivery_form WHERE user_name = '$user_name'";
...
<?php include 'expressmenu.php'; ?>
    <div class="container">
        ...
        <table class="table">
            ...
            <tbody>
                <?php 
                // Use the fetched user_id in the query to fetch specific rows
                $sql = "SELECT id, orderID, cus_id, cus_name, provinces, tracking_number, order_status, name_delivery FROM history WHERE id_delivery = '$user_id' ORDER BY reg_date DESC";
