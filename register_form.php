...
if(isset($_POST['submit'])){
    ...
    $insert = "INSERT INTO user_form (name, email, password, user_type, user_name, phone_number, sex, address, Ref_prov_id, Ref_dist_id, Ref_subdist_id, zip_code) 
           VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    $address = mysqli_real_escape_string($conn, $_POST['address']); 
      ...
      $select = "SELECT * FROM user_form WHERE user_name = '$user_name ' ";
...
<div class="form-container1">
   ...
   <form action="" method="post">
    ...
    <select class="form-control" name="Ref_subdist_id" id="districts">
      ...
      <p>เป็นสมาชิกอยู่แล้ว <a href="login_form.php">เข้าสู่ระบบ</a></p>
   </form>
